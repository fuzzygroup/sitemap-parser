  ...
  def raw_sitemap
    @raw_sitemap ||= begin
      if @url =~ /\Ahttp/i
        ...
        #request_options["User-Agent"] = "Mozilla/5.0 (Android 4.4; Mobile; rv:41.0) Gecko/41.0 Firefox/41.0"
        Typhoeus::Config.user_agent = "Mozilla/5.0 (Android 4.4; Mobile; rv:41.0) Gecko/41.0 Firefox/41.0"
